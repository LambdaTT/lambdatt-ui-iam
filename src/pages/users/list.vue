      ...
      <template #actions>
        <div class="row justify-end">
          <div
            ...
            class="col-12 col-md-4 q-py-xs-xs q-px-md-xs"
          >
            <q-btn
              class="full-width"
              icon="fas fa-plus"
      ...
      return [
        {
          ...
          fn: (row) => {
            this.$router.push(`/iam/users/details/${row.ds_key}`);
          },
        },
        {
          icon: "fas fa-edit",
          ...
          hide: !this.permissions.update,
          fn: (row) => {
            this.$router.push(`/iam/users/edit/${row.ds_key}`);
          },
        },
        {
  ...
  methods: {
    remove(row) {
      ...
      this.$getService("toolcase/http")
        .delete(`${ENDPOINTS.USERS.USER}/${key}`)
        .then(() => {
        ...
        .catch((error) => {
          ...
          console.error(
            "An error occurred on the attempt to delete users.",
            error,
          );
        })
        .finally(() => {
